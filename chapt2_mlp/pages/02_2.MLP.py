...
with tab2:
    ...
    _, col1, _ = st.columns([1, 4, 1])
    with col1:
        st.image('./pages/图片/图片16.jpg', caption='图16')
    ...
    with col1:
        st.image('./pages/图片/图片18.png', caption='图18 SGD')
    with col2:
        st.image('./pages/图片/图片19.png', caption='图19 Momentum')
    ...
    with col1:
        st.image('./pages/图片/图片21.gif', caption='图21')
    with col2:
        st.image('./pages/图片/图片22.gif', caption='图22')
    _, col1, _= st.columns([1, 1.2, 1])
    with col1:
        st.image('./pages/图片/图片23.gif', caption='图23')
    r"""$ \qquad $ 总结："""
