...
"""
    ...
    with col1:
        st.image('./pages/图片/图片1.jpg', caption='图1 一维卷积示例图')
    ...
    _, col1, _ = st.columns([1, 4, 1])
    with col1:
        st.image('./pages/图片/图片2.gif', caption='图2 二维卷积的计算过程')
...
""")
    _, col1, _ = st.columns([1, 4, 1])
    with col1:
        st.image('./pages/图片/图片3.png', caption='图3 卷积层的三维结构表示')
    ...
    with col1:
        st.image('./pages/图片/图片6.png', caption='图6 参数共享')
    r"""$ \qquad $ 边缘提取的效率："""
    ...
    with col1:
        st.image('./pages/图片/图片9.gif', caption='图9 padding:(0,0),stride:(1,1)')
    with col2:
        st.image('./pages/图片/图片10.gif', caption='图10 padding:(2,2),stride:(1,1)')
    with col3:
        st.image('./pages/图片/图片11.gif', caption='图11 padding:(0,0),stride:(2,2)')
    """- 卷积的变种："""
    r"""$ \qquad $ 1. 常规卷积"""
    r"""$ \qquad $ 2. 空洞卷积"""
    r"""$ \qquad $ 3. 分组卷积"""
...
with tab2:
    ...
    _, col1, _ = st.columns([1, 4, 1])
    with col1:
        st.image('./pages/图片/图片12.jpg', caption='图12 池化的计算过程')
    """- 池化的作用："""
