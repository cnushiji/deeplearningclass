...
with tab2:
    ...
    with col1:
        st.image('./pages/图片/图片43.jpg', caption='图43')
    ...
    _, col1 = st.columns([1, 2])
    with col1:
        st.image('./pages/图片/图片47.jpg', caption='图47')
    ...
    _, col1 = st.columns([1, 2])
    with col1:
        st.image('./pages/图片/图片48.jpg', caption='图48')
    """$ \qquad $ 下面进一步地做推广，我们考虑z与x都是二维分布的情形。"""
    _, col1 = st.columns([1, 2])
    with col1:
        st.image('./pages/图片/图片49.jpg', caption='图49')
    ...
    _, col1 = st.columns([1, 2])
    with col1:
        st.image('./pages/图片/图片57.jpg', caption='图57')
...
with tab3:
    ...
    _, col1 = st.columns([1, 2])
    with col1:
        st.image('./pages/图片/图片62.jpg', caption='图62')
    ...
    _, col1 = st.columns([1, 2])
    with col1:
        st.image('./pages/图片/图片63.jpg', caption='图63')
    ...
    _, col1 = st.columns([1, 2])
    with col1:
        st.image('./pages/图片/图片66.jpg', caption='图66')
    ...
    _, col1 = st.columns([1, 2])
    with col1:
        st.image('./pages/图片/图片68.jpg', caption='图68')
    ...
    _, col1 = st.columns([1, 2])
    with col1:
        st.image('./pages/图片/图片69.jpg', caption='图69')
    ...
    _, col1 = st.columns([1, 2])
    with col1:
        st.image('./pages/图片/图片70.jpg', caption='图70')
    ...
    _, col1 = st.columns([1, 2])
    with col1:
        st.image('./pages/图片/图片71.jpg', caption='图71')
    ...
    _, col1 = st.columns([1, 2])
    with col1:
        st.image('./pages/图片/图片72.jpg', caption='图72')
